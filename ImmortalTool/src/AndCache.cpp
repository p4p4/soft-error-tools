...
// -------------------------------------------------------------------------------------------
/// @file AndCache.cpp
/// @brief Contains the definition of the class AndCache.
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
AndCache::AndCache(SatSolver* solver) : solver_(solver)
{
}
...
// -------------------------------------------------------------------------------------------
int AndCache::addAndGate(int left, int right, int& next_free_cnf_var)
{
	...
	pair<uint64_t, int> new_cache_item(comb, next_free_cnf_var + 1);
